...
- Handles common cookie consent technologies: Sourcepoint, OneTrust, Shopify Customer Privacy, ConsentManager, Didomi, Iubenda, CookieScript, TrustArc, AppConsent, and custom site-specific flows.
