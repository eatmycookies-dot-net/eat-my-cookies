...
const CMP_FINGERPRINTS = [
  ...
  { name: 'Magento Cookie Notice', scripts: ['Magento_Cookie/js/notices'],           globals: [],                               selectors: ['.message.global.cookie', '.cookie.message', '[data-role="cookie-settings"]'] },
  { name: 'BigCommerce Catalyst', scripts: ['bigcommerce', 'c15t'],                  globals: [],                               selectors: ["meta[name='platform'][content='bigcommerce.catalyst']"] },
  ...
  { name: 'Complianz',      scripts: ['complianz'],                                 globals: ['cmplz_data'],                   selectors: ['#cmplz-cookiebanner-container', '.cmplz-cookiebanner'] },
  { name: 'Borlabs',        scripts: ['borlabs-cookie'],                            globals: ['BorlabsCookie'],                selectors: ['#BorlabsCookieBox', '.show-cookie-box'] },
  { name: 'Cookie Information', scripts: ['cookieinformation'],                     globals: ['CookieInformation'],            selectors: ['#coiOverlay', '#coiConsentBanner', '#coi-banner-wrapper'] },
  { name: 'Cookie Wow',     scripts: ['cookiewow'],                                 globals: ['CookieWow'],                    selectors: ['.cwc-banner-container', '.cwc-consent-summary-container'] },
  { name: 'Cookie Control by Civic', scripts: ['cookiecontrol', 'civiccomputing'],  globals: ['CookieControl'],                selectors: ['#ccc-notify .ccc-notify-button', '#ccc-content', '#ccc[open]'] },
  { name: 'Truendo',        scripts: ['truendo'],                                   globals: ['truendo'],                      selectors: ['#truendo_container div[class*="tru_cookie-dialog"]', '#truendo_container #tru_options_btn'] },
